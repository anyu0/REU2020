...
\begin{frame}{Multiple random walks}
	...
	\item An \textcolor{red}{\textit{avoiding Bernoulli line ensemble}} $\mathfrak{L} = (L_1,\dots,L_k)$ consists of $k$ avoiding Bernoulli random walks on an interval $[T_0,T_1]$ with random entry and exit data $\mathfrak{L}(T_0),\mathfrak{L}(T_1)$, such that $L_1(s) \geq L_2(s) \geq \cdots \geq L_k(s)$ for $s\in[T_0,T_1]$
