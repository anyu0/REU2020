...
\begin{proof}
	...
	\mathbb{P}^{-t_2,0,x_{k-1}',z_{k-1}'}_{Ber}\Big(\ell_1(-t_{12}) \geq \frac{t_{12}}{t_2}x_{k-1}' + \frac{t_2-t_{12}}{t_2}z_{k-1}' - (2t_2)^{1/4}\Big) \geq \frac{1}{3}.
	\end{equation}  
	...
	\end{equation}
	It follows from our choice of $V_1^b$ and $K_1 = 2(4r+7)V_1^b$ in \eqref{5.10Vb}, and \eqref{4r+7}, that 
	\begin{align*}
	...
	&> -pt_{12} - Ck(2t_2)^{1/2} - M_1(2t_2)^{1/2} + \frac{1}{4r+7}\,K_1(2t_2)^{1/2}\\
	&\geq -pt_{12} + (M_1 + Ck + 2(M_2+R))(2t_2)^{1/2}\\
	&> -pt_{12} + (2t_2)^{1/2}V_1^b.
	\end{align*}
	For the first inequality, we used the fact that $t_{12}/t_2 < 1$, and we assumed that $N$ is sufficiently large so that $C(k-1)(2t_2)^{1/2} + (2t_2)^{1/4} < Ck(2t_2)^{1/2}$. Using \eqref{5.10third1}, we conclude that
