...
\begin{proof}[Lemma \ref{LemmaAP1}]
	...
	\end{equation}
	with $Z' = \ex_{\tilde{\mathfrak{L}}'}\left[Z\left(-t_1, t_1, \mathfrak B(-t_1), \mathfrak B(t_1), \ell_{bot}\llbracket -t_1, t_1\rrbracket\right)\right]$. The first equality holds simply because the measures are discrete. To prove the second equality, let $\Omega_a(\cdot)$ denote $\Omega_{avoid}(\cdot)$ for simplicity, and let $\Omega_a(S)$ denote the set of elements of $\Omega_{avoid}(-t_2,t_2,\tilde{\mathfrak{L}}(-t_2),\tilde{\mathfrak{L}}(t_2))$ restricted to $S$. Then we have
	\[
	...
	\]
	\[
	Z(-t_1,t_1,\mathfrak{B}(-t_1),\mathfrak{B}(t_1),\ell_{bot}) = \frac{|\Omega_a(-t_1,t_1,\mathfrak{B}(-t_1),\mathfrak{B}(t_1),\ell_{bot})|}{|\Omega_a(-t_1,t_1,\mathfrak{B}(-t_1),\mathfrak{B}(t_1))|},
	\]
	and hence
	\begin{equation*}
	\begin{split}
	...
	&= \frac{\sum_{\mathfrak{B}\in\Omega_a(S)}|\Omega_a(-t_1,t_1,\mathfrak B(-t_1),\mathfrak B(t_1),\ell_{bot})|}{|\Omega_a(-t_2,t_2,\mathfrak B(-t_2),\mathfrak B(t_2),\tilde{\ell}_{bot})|} = \frac{|\Omega_a(-t_2,t_2,\mathfrak B(-t_2),\mathfrak B(t_2),\ell_{bot})|}{|\Omega_a(-t_2,t_2,\mathfrak B(-t_2),\mathfrak B(t_2),\tilde{\ell}_{bot})|}.
	\end{split}
	\end{equation*}
...
\begin{proof}
	...
	\end{equation}
	Let us define vectors $\vec{x}\,', \vec{z}\,', \vec{y}\,'$ by
	\begin{align*}
